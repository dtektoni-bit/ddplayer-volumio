...
# Compiles and installs the kernel driver for DDPlayer DAC
...
echo ""
echo "[2/6] Setting up kernel source..."
...
if [ ! -d "$KERNEL_SRC" ]; then
    ...
    rpi-source --dest /home/volumio 2>&1 | tail -5
...
echo ""
echo "[3/6] Preparing kernel source..."
...
echo ""
echo "[4/6] Building Module.symvers from installed modules..."
...
with open(f'/home/volumio/ddplayer-kernel-src/Module.symvers', 'w') as f:
...
echo ""
echo "[5/6] Compiling DDPlayer DAC driver..."
...
cp snd-soc-ddplayer-dac.ko "$MODULE_DEST/"
depmod -a
cp ddplayer-dac.dtbo "$OVERLAY_DEST/"
...
echo ""
echo "================================================"
echo " DDPlayer DAC installed! Please reboot."
echo "================================================"
